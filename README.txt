...
_____________________________________________Folder Structure__________________________________________________
	...
	├──  cart.php 
	├──  index.php
	├──  estore.sql (Database of the project	)
	├──  login.php
	├──  login_script.php
	├──  logout_script.php
	├──  products.php
...
2.) Open the phpMyAdmin and create a database "estore". 
3.) Import the estore.sql file present in the zip folder.
4.) Open the htdocs folder in the xampp folder. Copy paste the folder estore.
5.) Open the browser (chrome), type localhost/estore and you should see the index page of the website.

*******************************************************************************************************************************************
CONTACT ME: suhalkaaayush@gmail.com
FOLLOW ME : aayush.suhalka @instagram, vision.tales @instagram, Aayush Suhalka @Linkedin
